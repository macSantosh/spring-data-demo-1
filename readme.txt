...
#2. got to ojdbc8.jar location on your machine and run below command to add jar file to mvn repo
...
#3.import this project as maven project and update maven repo. (right click on proeject->maven->update project)
